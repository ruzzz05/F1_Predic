...
# Load FastF1 2024 Australian GP race session, R de Race, puedes cargar otras sesiones
session_2024 = fastf1.get_session(2024, 3, "R")
session_2024.load()

# Extract lap times
# Coge las columnas de Driver y LapTime
laps_2024 = session_2024.laps[["Driver", "LapTime"]].copy()
# Elimina las partes donde ponga Na, es decir vacias
laps_2024.dropna(subset=["LapTime"], inplace=True)
# Pasa los tiempos a decimales
...
# Añade nueva columna con el codigo del piloto
qualifying_2025["DriverCode"] = qualifying_2025["Driver"].map(driver_mapping)

# Une los datos de las vueltas de clasificacion, con el resultado de 2024
